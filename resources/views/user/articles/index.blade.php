                        ...
                        @foreach ($articles as $article)
                            <tr>
                                ...
                                <td class="flex gap-4 justify-center">
                                    <a href="{{ route('article.show', $article->id) }}" class="btn font-medium btn-primary border-none p-3">Detail</a>
                                    <a href="{{ route('user.article.edit', $article->id) }}" class="btn font-medium border-none p-3">Edit</a>
