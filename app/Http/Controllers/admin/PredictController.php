...
class PredictController extends Controller
{
    ...
    {
        return view('admin.predicts.index');
    }
    ...
    public function prediction_stock(Request $request)
    {
        ...
        return redirect()->route('admin.predict.show', compact('prediction', 'category', 'inventory', 'demand'));
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('admin.predicts.show', compact('prediction', 'category', 'inventory', 'demand'));
    }
}
